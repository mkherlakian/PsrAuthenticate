...
namespace MauricekTest\Unit\AuthProvider;
...
class JwtValidationProviderTest extends TestCase
{
    private $jwtKey;
    private $expiration;
    ...
    public function setUp()
    {
        ...
        $this->validationProvider = new JwtValidationProvider(
            $authStore->reveal(),
            $this->parser,
            $this->signer,
            $this->validator,
    ...
    public function testValidToken()
    {
        ...
        $credentials = $this->validationProvider->validate($request->reveal());

        $this->assertEquals('some_user_id', $credentials->memberId());
        $this->assertEquals('member', $credentials->role());
        $this->assertEquals('some_username', $credentials->username());
    }
    ...
    public function testMissingHeader()
    {
        ...
        $credentials = $this->validationProvider->validate($request->reveal(), $delegate->reveal());
    ...
    public function testInvalidSignature()
    {
        ...
        $response = $this->validationProvider->validate($request->reveal(), $delegate->reveal());
    }
